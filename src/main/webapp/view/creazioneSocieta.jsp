...
<% String esistente=(String)request.getAttribute("societaEsistente");
	String campiVuoti=(String)request.getAttribute("campiVuoti");
	String errorePIVa=(String)request.getAttribute("partitaIvaErrata");
