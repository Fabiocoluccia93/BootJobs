...
public class Category_controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher rs = request.getRequestDispatcher("/webapp/OffertaLavoro.jsp");
        ...
        String requestScope = (String)request.getAttribute("subcategory_name");

        // print response
        response.setContentType("OffertaLavoro/jsp");
